...
\slide{Source code}{Coq with linerange}{
  lstinputlisting の option で \minitt{linerange=\{2-6\}} とすると、2行目から6行目まで表示される
  \lstinputlisting[
    language=Coq,
    style=default,
    linerange={2-6},
    caption={Example of linerange}
  ]{./src/coq.v}
}

\slide{Source code}{Haskell}{
  \lstinputlisting[language=Haskell,style=default]{./src/haskell.hs}
}
...
\slide{Source code}{OCaml}{
  \lstinputlisting[language=OCaml,style=default]{./src/ocaml.ml}
}

\begin{frame}[fragile]{lstlisting}{}

  requires \minitt{fragile} option
